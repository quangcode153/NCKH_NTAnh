...
def func_mixture(argv=None, video_path=None, choice_snrs=None, choice_blurs=None, noise_paths=None, save_root=None):
    ...
    split_audio_from_video(video_path, save_path1)
    info_a_noise = add_noise_to_audio(save_path1, noise_paths, snr, save_path2)
    info_v_noise = add_noise_to_video(video_path, blur, save_path3)
    merge_audio_and_video(save_path2, save_path3, save_path4)

    os.system('rm -rf \"%s\" \"%s\" \"%s\"' %(save_path1, save_path2, save_path3))
